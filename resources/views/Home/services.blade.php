        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 justify-content-center align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link seccolor me-4 res" href="/#ourstory">About Us</a>
                    </li>
                    <li class="">
                        <a class="nav-link seccolor me-4 res" href="/#ourservices">Services</a>
                    </li>
                    @if (Route::has('login'))
                        <div>
                            @auth
                                <a href="{{ url('/admin') }}" class="nav-link me-4 seccolor ">Dashboard</a>
                            @else
                                <div class="d-flex">
                                    <li class="nav-item">
